...
proc_exit: BEGIN
    ...
    DECLARE cur CURSOR FOR 
        SELECT id, winner_conditions.name, amount_min, amount_max, winnings, winning_percentage, reset_every
...
--             VALUES (v_msisdn, v_short_code, v_account, v_cronjob_id, v_condition_id, v_winnings, v_amount, v_customer_name, v_transaction_code);
            ...
            INSERT INTO winners_selection.unhash_queue (hashed_msisdn, shortcode, keyword, amount_won, amount_transacted, customer_name, transaction_code, is_winner)
            VALUES (v_msisdn, v_short_code, v_account, v_winnings, v_amount, v_customer_name, v_transaction_code, 1);
        ELSE
